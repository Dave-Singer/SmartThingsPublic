...
metadata {
	...
	simulator {
        ...
        input "parameterEighteen", "number", title: "PIR Timeout Duration (minutes): default=2, 1-60",  defaultValue: 2, range: "1..60", required: false, displayDuringSetup: true
...
def installed() {
// Device wakes up every 3 hours, this interval allows us to miss one wakeup notification before marking offline
